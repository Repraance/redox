import { ExtractRematchDispatcherFromReducer } from '../types'
...
export type DispatcherOfReducer<T> = T extends (s: infer _S, p: infer P) => infer R ? (payload?: P) => R : T
...
export const testUse: IUseModel = <S, RM extends ModelCollection, R extends Reducers<S>, E extends Effects<S, R, RM>>(_model: InternalModel<S, RM, R, E>) => {
